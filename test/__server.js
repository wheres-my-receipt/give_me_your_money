...
lab.experiment("When the user visits the registration page, ", function() {
	lab.test("they should be able to register as a user", function(done) {

	});
});

lab.experiment("When visits the login page, ", function() {
	lab.test("blah blah blah", function(done) {
